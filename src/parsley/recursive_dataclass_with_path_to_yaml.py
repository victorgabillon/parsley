    ...
    *,
    ...
    for dataclass_type in dataclass_type_list:
        try:
            ...
            return remove_notfilled_values(overwrite_resolved_val_temp)
        except _PARSE_EXCEPTIONS:
            continue
